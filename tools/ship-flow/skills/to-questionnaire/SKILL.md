...
>
> The questionnaire itself is a human-facing artifact: write it in the recipient's language, which is
> `outputLanguage` unless the user says the recipient reads another one. Ask if it is not obvious.
